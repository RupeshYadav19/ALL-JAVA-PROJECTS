...
public class StudentRegistration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(40, 40, 250, 60);
        ...
        ImageIcon iconReg = new ImageIcon(getClass().getResource("/img/All Page Backgraound.png"));
        Image imgReg = iconReg.getImage().getScaledInstance(1140, 770, Image.SCALE_SMOOTH);
        jLabel4.setIcon(new ImageIcon(imgReg));
